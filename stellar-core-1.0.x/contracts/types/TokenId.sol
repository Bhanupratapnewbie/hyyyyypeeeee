...
/// @title Stellar's tokenId: the fundamental options position.
...
/// @notice Contains methods for packing and unpacking a Stellar options position into a uint256 bit pattern.
...
library TokenIdLibrary {
    ...
    /// @return The `poolId` (Stellar's pool fingerprint, contains the whole 64 bit sequence with the tickSpacing) of the Uniswap V3 pool
    ...
    function asTicks(
        ...
        (legLowerTick, legUpperTick) = StellarMath.getTicks(
