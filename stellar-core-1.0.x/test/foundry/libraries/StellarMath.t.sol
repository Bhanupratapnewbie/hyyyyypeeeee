...
import {StellarMathHarness} from "./harnesses/StellarMathHarness.sol";
...
/**
 * Test the StellarMath functionality with Foundry and Fuzzing.
 *
 * @author Axicon Labs Limited
 */
contract StellarMathTest is Test, PositionUtils {
    using Math for uint256;
    // harness
    StellarMathHarness harness;
    ...
    function setUp() public {
        harness = new StellarMathHarness();
    }
    ...
    function test_Success_getAmountsMoved_asset0(
        ...
        // contruct a tokenId
        {
            ...
            int24 rangeDown;
            int24 rangeUp;
            (rangeDown, rangeUp) = StellarMath.getRangesFromStrike(width, int24(tickSpacing));
