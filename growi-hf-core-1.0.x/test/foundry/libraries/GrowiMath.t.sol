...
import {GrowiMathHarness} from "./harnesses/GrowiMathHarness.sol";
...
/**
 * Test the GrowiMath functionality with Foundry and Fuzzing.
 *
 * @author Axicon Labs Limited
 */
contract GrowiMathTest is Test, PositionUtils {
    using Math for uint256;
    // harness
    GrowiMathHarness harness;
    ...
    function test_Success_getAmountsMoved_asset0(
        ...
        // contruct a tokenId
        {
            ...
            int24 rangeDown;
            int24 rangeUp;
            (rangeDown, rangeUp) = GrowiMath.getRangesFromStrike(width, int24(tickSpacing));
