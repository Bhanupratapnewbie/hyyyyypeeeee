...
/// @title Growi's tokenId: the fundamental options position.
...
/// @notice Contains methods for packing and unpacking a Growi options position into a uint256 bit pattern.
...
library TokenIdLibrary {
    ...
    /// @return The `poolId` (Growi's pool fingerprint, contains the whole 64 bit sequence with the tickSpacing) of the Uniswap V3 pool
    ...
    function asTicks(
        ...
        (legLowerTick, legUpperTick) = GrowiMath.getTicks(
